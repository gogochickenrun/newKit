...
(function () {
  ...
  class FlutterServiceWorkerLoader {
    ...
    loadServiceWorker(settings) {
      ...
      const {
        ...
        serviceWorkerUrl = `https://gogochickenrun.github.io/newKit/flutter_service_worker.js?v=${serviceWorkerVersion}`,
        timeoutMillis = 4000,
      } = settings;
  ...
  class FlutterEntrypointLoader {
    ...
    async loadEntrypoint(options) {
      const { entrypointUrl = `https://gogochickenrun.github.io/newKit/main.dart.js`, onEntrypointLoaded } =
        options || {};
